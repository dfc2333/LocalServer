...
## 1. 简介
`Server.pyw` 是一个基于 `Flask` 的局域网服务器脚本，支持多种功能，包括文件传输、音乐下载、视频下载、AI 对话接口、消息管理等。以下是其主要功能和配置方法。
...
### 2.1 安装依赖
确保已安装 Python 3.6+，并安装以下依赖库：
```bash
pip install flask requests urllib3
```

### 2.2 配置文件
`Server.pyw` 依赖 `config.py` 文件进行配置。
...
#### 文件传输
- **下载本地文件**: `/local/<filename>`
- **下载网易云音乐文件**: `/net/wyy/<songName>/<list>`
- **下载 QQ 音乐文件**: `/net/qq/<songName>/<list>`
...
4. **日志管理**: 日志文件存储在 `log_dir` 中，定期清理以释放空间。
